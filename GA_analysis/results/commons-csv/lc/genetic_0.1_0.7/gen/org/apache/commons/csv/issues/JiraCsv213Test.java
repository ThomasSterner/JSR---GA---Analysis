...
public class JiraCsv213Test {
    ...
    private void createEndChannel(final File csvFile) {
        ...
        // @formatter:on
        try (CSVParser parser = csvFormat.parse(new InputStreamReader(new FileInputStream(csvFile), StandardCharsets.UTF_8))) {
            if (parser.iterator().hasNext()) {
                ...
                // this fails
                final CSVRecord firstRecord = parser.iterator().next();
                return;
            }
