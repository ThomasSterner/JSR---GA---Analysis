...
public class NumberUtilsTest {
    ...
    public // Check that the code fails to create a valid number when preceded by -- rather than -
    void testCreateNumberFailure_1() {
        NumberUtils.createNumber("--1.1E-700F");
    }

    @Test(expected = NumberFormatException.class)
    public // Check that the code fails to create a valid number when both e and E are present (with decimal)
    void testCreateNumberFailure_2() {
        NumberUtils.createNumber("-1.1E+0-7e00");
    }

    @Test(expected = NumberFormatException.class)
    public // Check that the code fails to create a valid number when both e and E are present (no decimal)
