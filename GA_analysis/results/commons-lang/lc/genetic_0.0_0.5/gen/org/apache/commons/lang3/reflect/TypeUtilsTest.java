...
public class // raw types, where used, are used purposely
TypeUtilsTest<B> {
    ...
    public void testParameterize() throws Exception {
        ...
        Assert.assertTrue(TypeUtils.equals(getClass().getField("stringComparable").getGenericType(), stringComparableType));
    ...
    public void testWildcardType() throws Exception {
        ...
        Assert.assertTrue(TypeUtils.equals(((ParameterizedType) cClass.getGenericType()).getActualTypeArguments()[0], simpleWildcard));
...
class // raw types, where used, are used purposely
AClass extends AAClass<String>.BBClass<Number> {
