...
public class RandomStringUtilsTest {
    ...
    public void testLANG807() {
        try {
            ...
            // distinguish from Random#nextInt message
    ...
    public void testExceptions() {
        ...
        try {
            // must not provide empty array => IAE
    ...
    public void testRandomAlphaNumeric() {
        ...
        for (int i = 0; i < testChars.length; i++) {
            if (!found[i]) {
                fail("alphanumeric character not generated in 1000 attempts: " + testChars[i] + " -- repeated failures indicate a problem ");
            }
        }
    }
    ...
    public void testRandomNumeric() {
        ...
        for (int i = 0; i < testChars.length; i++) {
            if (!found[i]) {
                fail("digit not generated in 1000 attempts: " + testChars[i] + " -- repeated failures indicate a problem ");
            }
        }
    }
    ...
    public void testRandomAscii() {
        ...
        for (int i = 0; i < testChars.length; i++) {
            if (!found[i]) {
                fail("ascii character not generated in 1000 attempts: " + (int) testChars[i] + " -- repeated failures indicate a problem");
            }
        }
    }
