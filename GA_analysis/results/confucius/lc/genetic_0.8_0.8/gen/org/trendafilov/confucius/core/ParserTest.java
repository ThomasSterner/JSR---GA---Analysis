...
public class ParserTest {
    ...
    public void testDefaultContext() {
        ...
        for (Entry<String, String> entry : configuration.entrySet()) assertEquals(map.get(entry.getKey()), entry.getValue());
    }
    ...
    public void testLegacyFormat() throws Exception {
        String configurationString = new StringBuilder().append("key1=value1\n").append(" \n").append("key3=value3\n").toString();
    ...
    private Map<String, String> makeMap(String... args) {
        ...
        for (int i = 0; i < args.length; i++) map.put(args[i], args[++i]);
        return map;
    }
}
