...
public class ExpressionTest {
    ...
    public void testExpression1() {
        Token[] tokens = new Token[] { new NumberToken(3d), new NumberToken(2d), new OperatorToken(Operators.getBuiltinOperator('+', 2)) };
    ...
    public void testExpression2() {
        Token[] tokens = new Token[] { new NumberToken(1d), new FunctionToken(Functions.getBuiltinFunction("log")) };
        Expression exp = new Expression(tokens);
    ...
    public void testGetVariableNames1() {
        Token[] tokens = new Token[] { new VariableToken("a"), new VariableToken("b"), new OperatorToken(Operators.getBuiltinOperator('+', 2)) };
        Expression exp = new Expression(tokens);
    ...
    public void testInvalidCotangent1() {
        Expression e = new ExpressionBuilder("cot(0)").build();
        e.evaluate();
    }
    ...
    @Test
    @Ignore
    public // If Expression should be threads safe this test must pass
    void evaluateFamily() {
