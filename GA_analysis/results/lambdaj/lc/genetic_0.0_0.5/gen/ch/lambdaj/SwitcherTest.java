...
public class SwitcherTest {
    ...
    public void testExecSwitch() {
        Switcher<Integer> switcher = new Switcher<Integer>().addCase("+", new Closure() {

            {
                of(SwitcherTest.this).add(var(Integer.class), var(Integer.class));
            }
        }).addCase("-", closure().of(this, "sub", var(Integer.class), var(Integer.class))).addCase("*", closure().of(this, "mul", var(Integer.class), var(Integer.class))).addCase("/", closure().of(this, "div", var(Integer.class), var(Integer.class)));
    ...
    public void testExecAllSwitch() {
        Switcher<Integer> switcher = new Switcher<Integer>().addCase(contains("+"), closure().of(this, "add", var(Integer.class), var(Integer.class))).addCase(contains("-"), closure().of(this, "sub", var(Integer.class), var(Integer.class))).addCase(contains("*"), closure().of(this, "mul", var(Integer.class), var(Integer.class))).addCase(contains("/"), closure().of(this, "div", var(Integer.class), var(Integer.class)));
    ...
    public void testSwitchOnPersons() {
        Switcher<String> switcher = new Switcher<String>().addCase(new Person("me", 35), "me").addCase(having(on(Person.class).getAge(), lessThan(30)), "young").addCase(having(on(Person.class).getAge(), greaterThan(70)), "old").setDefault("adult");
    ...
    public void testSwitchAsFactory() {
        Switcher<Person> factory = new Switcher<Person>().addCase("me", closure().of(Person.class, Closure.CONSTRUCTOR, "Mario", var(Integer.class))).addCase("sis", closure().of(Person.class, Closure.CONSTRUCTOR, "Irma", var(Integer.class))).addCase("dad", closure().of(Person.class, Closure.CONSTRUCTOR, "Domenico", var(Integer.class)));
