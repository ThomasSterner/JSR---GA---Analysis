...
public class ClosureTest {
    ...
    public void testSystemOut() {
        Closure1<String> println = closure(String.class);
        {
    ...
    public void testTypedOnList() {
        StringWriter sw = new StringWriter();
        Closure1<String> writer = closure(String.class);
        {
            of(sw).append(var(String.class));
        }
        writer.each(asList("first", "second", "third"));
    ...
    public void testUntypedDo4OnInt() {
        Closure4<Integer, Integer, Integer, Integer> adder = closure(Integer.class, Integer.class, Integer.class, Integer.class).of(this, "doNonCommutativeOpOnInt", var(Integer.class), var(Integer.class), var(Integer.class), var(Integer.class));
        int result = (Integer) adder.apply(5, 2, 4, 3);
        assertEquals((5 - 2) * (4 - 3), result);
    }
    ...
    public void testWrongCurry() {
        ...
        {
            of(this).doNonCommutativeOpOnInt(var(Integer.class), var(Integer.class), var(Integer.class), 10);
        }
        try {
            closure.curry(3, 4);
    ...
    public void tesFinalClosureWithParams() {
        Closure3<String, Integer, Integer> varSubstring = closure(String.class, Integer.class, Integer.class).of(String.class, "substring", var(Integer.class), var(Integer.class));
        assertEquals("ar", varSubstring.apply("mario", 1, 3));
        Closure2<Integer, Integer> fixedSubstring = closure(Integer.class, Integer.class).of("mario", "substring", var(Integer.class), var(Integer.class));
