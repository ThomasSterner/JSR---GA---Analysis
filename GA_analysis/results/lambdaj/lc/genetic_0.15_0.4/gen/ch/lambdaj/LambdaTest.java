...
public class LambdaTest {
    ...
    public void testStringPropertyExtractor() {
        ...
        for (int i = 0; i < meAndMyFriends.size(); i++) assertEquals(agesAsString.get(i), String.valueOf(meAndMyFriends.get(i).getAge()));
    }
    ...
    public void testNestedStringPropertyExtractor() {
        ...
        for (int i = 0; i < meAndMyFriends.size(); i++) {
            ...
            if (bestFriend == null)
                assertEquals(agesAsString.get(i), "");
            else
                assertEquals(agesAsString.get(i), String.valueOf(bestFriend.getAge()));
        }
    }
